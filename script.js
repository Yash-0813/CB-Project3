...
if(localStorage.getItem("yessss")){
    ticketArr = JSON.parse(localStorage.getItem("yessss"));
...
function createTicket(ticketColor, ticketTask, ticketID) {
    ...
    if(!ticketID) {
        ...
        localStorage.setItem("yessss",JSON.stringify(ticketArr));
    }
...
function handleRemoval(ticket , id) {
    ...
    ticket.addEventListener("click" , (e) =>{
        ...
        localStorage.setItem("yessss", strTicketArr);
...
function handleLock(ticket , id) {
    ...
    ticketLock.addEventListener("click", (e) => {
        ...
        localStorag.setItem("yessss",JSON.stringify(ticketArr));
    })
}
